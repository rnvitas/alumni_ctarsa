            ...
            <div class="container-search d-flex justify-content-center mb-5">
                ...
                <div class="col-lg-10  search-filter d-flex justify-content-center align-items-center">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="search-bar form" id="st_ps">
                            ...
                            <?php if ($this->uri->segment(2) == 'popular_search') { ?>
                                <input type="text" class="form-control form-input" id="search" value="<?php echo $this->input->get('st_p') ?>">
                            <?php } else { ?>
                                <input class="form-control form-input" type="text" id="search" placeholder="Search...">
                            <?php } ?>

                            <select class="select2 js-example-basic-single custom-select" id="sh" onchange="short_p()">
                                <?php if ($this->input->get('sh_p') == 'popular') { ?>
                                    <option value="new">Terbaru</option>
                                    <option selected="selected" value="popular">Terpopuler</option>
                                <?php } else if ($this->input->get('sh_p') == 'new') { ?>
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-12 d-flex justify-content-center">
                    <ul id="portfolio-filters">
                        <?php
                        if ($this->input->get('cat_p') == 'All' || empty($this->input->get('cat_p'))) { ?>
                        ...
                        foreach ($category as $row) {
                            if ($this->input->get('cat_p') == $row->category_name) { ?>
