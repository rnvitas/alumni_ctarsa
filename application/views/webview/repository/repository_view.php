        ...
        <div class="row clearfix">
            <div class=" col-lg-8 col-md-12 left-box-repository">
                <div class="row">
                    ...
                    <?php foreach ($all_repo as $a) { ?>
                        ...
                        <div class="ccol-xs-12 col-sm-6 col-md-4 col-lg-4 col-6 pb-3" onclick="showDetail(<?php echo $a->id ?>)">
                            <div class="card-repository">
                                <img src=" <?php echo base_url(); ?>./../../../uploadFile_alumni/repository/<?php echo $a->thumbnail_image; ?>" class="card-repository-img-top" alt="...">
            ...
            <div class="col-lg-4 col-md-12 right-box-repository">
                ...
                <div class="card-repository card-terbaru">
                    <div class="header d-flex ml-2">
                        <h5 class="me-2"><b>Terbanyak dirujuk</b></h5>
