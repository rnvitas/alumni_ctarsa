            ...
            <div class="col-lg-12 d-flex container-forum">
                <div class="col-lg-9 mt-3">
                    ...
                    <div class="filter-forum">
                        <button class="btn btn-outline-primary btn-filter btnnya-actived me-3" href="<?php echo base_url('forum/all_forum') ?>">Back</button>
                    ...
                    <div class="card-forum-topic">
                        ...
                        <div class="card-topic mb-5">
                            ...
                            <div class="card-topic mb-5">
                                <!-- <h6 class="text-bold">Your Answer</h6> -->
                                <div class="card-topic-profile ">
                                    <img class="img-fluid topic-profile" src="https://d2v5dzhdg4zhx3.cloudfront.net/web-assets/images/storypages/short/linkedin-profile-picture-maker/dummy_image/thumb/004.webp">
                                    <div class="info-profile">
                                        <h6>Angelina Christine</h6>
                                ...
                                <div class="card-desc-topic">
                                    <div class="container">
                                        ...
                                        <div class="desc-topic">
                                            <textarea id="Repliesfield" style="background:#f5f5f5; border:none; border-radius:20px; text-align:left; padding:1rem 2rem; width:100%; "></textarea>
                            ...
                            <div class="heading-title-forum mb-5">
                                <h4 class="text-dark ms-3 mt-2 "><strong>100 Replies</strong></h4>
                            ...
                            <div class="card-topic mb-5">
                                ...
                                <div class="card-topic-profile d-flex justify-content-between">
                                    <div class="profile-user">
                                        <img class="img-fluid topic-profile" src="https://t3.ftcdn.net/jpg/02/43/12/34/360_F_243123463_zTooub557xEWABDLk0jJklDyLSGl2jrr.jpg">
                                        <div class="info-profile">
                                            <h6>Justin Agus</h6>
                                            <p>Alumni 2015</p>
                                        </div>
                                ...
                                <div class="card-action-topic d-flex justify-content-between">
                                    ...
                                    <div class="d-flex justify-content-end mb-3 icon-reply">
...
<script>
    /**
     * Show more and less - Truncate long content with jQuery
     * Copyright by havutcuoglu
     * https://codepen.io/havutcuoglu/pen/LYmxzLo
